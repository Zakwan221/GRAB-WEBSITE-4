...
const menuItems = {
    'Burger Barn': [
        { name: 'Classic Burger', desc: 'Beef patty, lettuce, tomato, cheese', price: 15.90, image: 'food-burger.jpg' },
        { name: 'Cheese Burger', desc: 'Double cheese, special sauce', price: 18.90, image: 'food-burger.jpg' },
        { name: 'Chicken Burger', desc: 'Crispy chicken, mayo, pickles', price: 16.90, image: 'food-burger.jpg' }
    ],
    'Noodle House': [
        { name: 'Ramen Bowl', desc: 'Pork broth, chashu, egg', price: 22.90, image: 'food-noodles.jpg' },
        { name: 'Udon Soup', desc: 'Hot udon noodles in broth', price: 18.90, image: 'food-noodles.jpg' },
        { name: 'Stir Fry Noodles', desc: 'Wok-fried with vegetables', price: 16.90, image: 'food-noodles.jpg' }
    ],
    'Pizza Paradise': [
        { name: 'Margherita', desc: 'Tomato, mozzarella, basil', price: 24.90, image: 'food-pizza.jpg' },
        { name: 'Pepperoni', desc: 'Pepperoni, cheese, tomato sauce', price: 28.90, image: 'food-pizza.jpg' },
        { name: 'Hawaiian', desc: 'Ham, pineapple, cheese', price: 26.90, image: 'food-pizza.jpg' }
    ],
    'Rice Bowl Express': [
        { name: 'Chicken Rice Bowl', desc: 'Grilled chicken, rice, vegetables', price: 14.90, image: 'food-rice.jpg' },
        { name: 'Beef Rice Bowl', desc: 'Tender beef, rice, sauce', price: 18.90, image: 'food-rice.jpg' },
        { name: 'Vegetable Rice Bowl', desc: 'Mixed vegetables, rice', price: 12.90, image: 'food-rice.jpg' }
    ],
    'Green Kitchen': [
        { name: 'Caesar Salad', desc: 'Fresh greens, croutons, dressing', price: 16.90, image: 'food-healthy.jpg' },
        { name: 'Quinoa Bowl', desc: 'Quinoa, vegetables, tahini', price: 18.90, image: 'food-healthy.jpg' },
        { name: 'Smoothie Bowl', desc: 'Acai, fruits, granola', price: 15.90, image: 'food-healthy.jpg' }
    ],
    'Boba Station': [
        { name: 'Classic Milk Tea', desc: 'Black tea, milk, pearls', price: 8.90, image: 'food-drinks.jpg' },
        { name: 'Taro Milk Tea', desc: 'Taro flavor, milk, pearls', price: 9.90, image: 'food-drinks.jpg' },
        { name: 'Fruit Tea', desc: 'Fresh fruits, tea base', price: 10.90, image: 'food-drinks.jpg' }
    ]
};
